          ...
          >
            <div className="flex items-end justify-end min-h-screen sm:items-center sm:p-4">
              ...
              <motion.div
                ...
                className="relative w-full sm:w-[400px] h-[600px] sm:h-[500px] bg-gradient-to-b from-white dark:from-[#1E1E1E] to-amber-50/30 dark:to-amber-900/10 rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-amber-100/50 dark:border-amber-900/50"
              >
                {/* Header del chat */}
                ...
                {/* Área de mensajes */}
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-amber-50/30 dark:from-amber-950/10 to-transparent">
                  <AnimatePresence>
                        ...
                        <motion.div
                          className={cn(
                            ...
                            message.sender === 'user' 
                              ...
                              : 'bg-white dark:bg-[#2A2A2A] border border-amber-100 dark:border-amber-800/50 dark:text-amber-100'
                          )}
                        >
                ...
                <div className="p-4 bg-white dark:bg-[#1E1E1E] border-t border-amber-100 dark:border-amber-900/50">
                  <form onSubmit={handleSendMessage} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-amber-50/50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/50 text-sm placeholder:text-amber-300 dark:placeholder:text-amber-700 dark:text-amber-100"
                      disabled={isLoading}
                    />
                    <motion.button
                      type="submit"
